...
# Seuraavassa esimerkkinä testi, joka testaa, 
# että ostostapahtuman jälkeen pankin metodia tilisiirto on kutsuttu:
class TestKauppa(unittest.TestCase):
    ...
    def test_kaksi_samaa_ostosta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asiointi_nollaa_edellisen_osotoksen_tiedot(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
